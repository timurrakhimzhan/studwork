...
export default class ReceiverBotContext extends AbstractBotContext {
    ...
    private orderInfo: {[key: number]: Order | undefined} = {};
    ...
    getOrderInfo = (chatId: number): Order => {
        if(this.orderInfo[chatId]) {
            return this.orderInfo[chatId] as Order;
        }
        this.orderInfo[chatId] = new Order();
        return this.orderInfo[chatId] as Order;
    }
